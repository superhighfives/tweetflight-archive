(function() {
  ...
  angular.module('tweetflight').controller('MainCtrl', [
    '$scope', '$http', function($scope, $http) {
      ...
      tweet_url = window.location.toString().match(/localhost/) && !window.location.toString().match(/\?live=1/) ? "http://localhost:5000/tweets.json?callback=JSON_CALLBACK" : "http://tweetflight.herokuapp.com/tweets.json?callback=JSON_CALLBACK";
